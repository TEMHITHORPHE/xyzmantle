    ...
    return <div className="py-6">
        ...
        <div className="h-12 bg-black relative rounded-lg ring-1 ring-stroke-inputs focus-within:ring-1 focus-within:ring-white/70">
            <div className="flex items-center text-lg h-[inherit]">
                <input className="grow border-0 focus:outline-none rounded-tl-lg rounded-bl-lg bg-black py-1.5 px-3 focus:ring-0 focus:ring-white/70 appearance-none"
                    disabled type="number" placeholder={isConnected ? "You will receive: 0.0 MNT" : "Unknown. Connect Wallet"}
                />
            </div>
        </div>
    </div>
